...
isBluebird.ctor = function(Promise) {
  return (
    ...
    !!Promise.prototype &&
    typeof Promise.prototype._addCallbacks == "function"
  );
};
...
isBluebird.v2.ctor = function(Promise) {
  return (
    isBluebird.ctor(Promise) && Promise.prototype._addCallbacks.length == 6
  );
};
...
isBluebird.v3.ctor = function(Promise) {
  return (
    isBluebird.ctor(Promise) && Promise.prototype._addCallbacks.length == 5
  );
};
