...
class HasMany extends Association {
  ...
  get(instances, options = {}) {
    ...
    if (instances) {
      values = instances.map(instance =>
        instance.get(this.sourceKey, { raw: true })
      );
  ...
  has(sourceInstance, targetInstances, options) {
    ...
    return this.get(sourceInstance, options).then(
      associatedObjects => associatedObjects.length === targetInstances.length
    );
  }
  ...
  set(sourceInstance, targetInstances, options) {
    ...
    return this.get(
      sourceInstance,
      _.defaults({ scope: false, raw: true }, options)
