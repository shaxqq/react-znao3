...
class QueryInterface {
  ...
  dropAllSchemas(options) {
    ...
    return this.showAllSchemas(options).map(schemaName =>
      this.dropSchema(schemaName, options)
    );
  }
  ...
  createTable(tableName, attributes, options, model) {
    ...
    if (this.sequelize.options.dialect === "postgres") {
      promise = PostgresQueryInterface.ensureEnums(
        this,
        tableName,
        attributes,
        options,
      ...
      if (this.sequelize.options.dialect === "postgres") {
        ...
        if (instanceTable) {
          ...
          for (let i = 0; i < keyLen; i++) {
            if (
              instanceTable.rawAttributes[keys[i]].type instanceof
              DataTypes.ENUM
            ) {
  ...
  dropAllTables(options) {
      ...
      Promise.each(tableNames, tableName => {
        ...
        if (!skip.includes(tableName.tableName || tableName)) {
          return this.dropTable(
            tableName,
            Object.assign({}, options, { cascade: true })
          );
        }
      });
    ...
    return this.showAllTables(options).then(tableNames => {
      if (this.sequelize.options.dialect === "sqlite") {
        return this.sequelize
          .query("PRAGMA foreign_keys;", options)
          .then(result => {
            ...
            if (foreignKeysAreEnabled) {
              return this.sequelize
                ...
                .then(() =>
                  this.sequelize.query("PRAGMA foreign_keys = ON", options)
                );
            }
            return dropAllTables(tableNames);
          });
      }
      return this.getForeignKeysForTables(tableNames, options).then(
        foreignKeys => {
          const queries = [];
          ...
          return Promise.each(queries, q =>
            this.sequelize.query(q, options)
          ).then(() => dropAllTables(tableNames));
        }
      );
    });
  ...
  removeColumn(tableName, attributeName, options) {
    ...
    switch (this.sequelize.options.dialect) {
      case "sqlite":
        ...
        return SQLiteQueryInterface.removeColumn(
          this,
          tableName,
          attributeName,
          options
      ...
      case "mssql":
        ...
        return MSSQLQueryInterface.removeColumn(
          this,
          tableName,
          attributeName,
          options
      ...
      case "mariadb":
        ...
        return MySQLQueryInterface.removeColumn(
          this,
          tableName,
          attributeName,
          options
  ...
  changeColumn(tableName, attributeName, dataTypeOrOptions, options) {
    ...
    attributes[attributeName] = this.sequelize.normalizeAttribute(
      attributes[attributeName]
    );

    if (this.sequelize.options.dialect === "sqlite") {
      // sqlite needs some special treatment as it cannot change a column
      return SQLiteQueryInterface.changeColumn(
        this,
        tableName,
        attributes,
        options
  ...
  renameColumn(tableName, attrNameBefore, attrNameAfter, options) {
    ...
    return this.describeTable(tableName, options).then(data => {
      if (!data[attrNameBefore]) {
        throw new Error(
          `Table ${tableName} doesn't have the column ${attrNameBefore}`
        );
      }
      ...
      if (this.sequelize.options.dialect === "sqlite") {
        ...
        return SQLiteQueryInterface.renameColumn(
          this,
          tableName,
          attrNameBefore,
          attrNameAfter,
  ...
  addIndex(tableName, attributes, options, rawTablename) {
    ...
    return this.sequelize.query(
      sql,
      Object.assign({}, options, { supportsSearchPath: false })
    );
  }
  ...
  showIndex(tableName, options) {
    ...
    return this.sequelize.query(
      sql,
      Object.assign({}, options, { type: QueryTypes.SHOWINDEXES })
    );
  }
  ...
  getForeignKeyReferencesForTable(tableName, options) {
    ...
    switch (this.sequelize.options.dialect) {
      case "sqlite":
        ...
        return SQLiteQueryInterface.getForeignKeyReferencesForTable(
          this,
          tableName,
          queryOptions
        );
  ...
  addConstraint(tableName, attributes, options, rawTablename) {
    ...
    if (this.sequelize.dialect.name === "sqlite") {
      return SQLiteQueryInterface.addConstraint(
        this,
        tableName,
        options,
        rawTablename
    ...
    const sql = this.QueryGenerator.addConstraintQuery(
      tableName,
      options,
      rawTablename
    );
  ...
  showConstraint(tableName, constraintName, options) {
    ...
    return this.sequelize.query(
      sql,
      Object.assign({}, options, { type: QueryTypes.SHOWCONSTRAINTS })
    );
  }
  ...
  removeConstraint(tableName, constraintName, options) {
    ...
    switch (this.sequelize.options.dialect) {
      ...
      case "mariadb":
        ...
        return MySQLQueryInterface.removeConstraint(
          this,
          tableName,
          constraintName,
          options
      ...
      case "sqlite":
        return SQLiteQueryInterface.removeConstraint(
          this,
          tableName,
          constraintName,
          options
      ...
      default:
        const sql = this.QueryGenerator.removeConstraintQuery(
          tableName,
          constraintName
        );
        return this.sequelize.query(sql, options);
  ...
  update(instance, tableName, values, identifier, options) {
    ...
    options.hasTrigger = !!(
      instance &&
      instance._modelOptions &&
      instance._modelOptions.hasTrigger
    );
