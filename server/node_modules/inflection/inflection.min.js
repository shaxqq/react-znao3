...
(function(a, b) {
  ...
  var b = {
    ...
    pluralize: function(m, l) {
      return b._apply_rules(m, g, d, l);
    },
    singularize: function(m, l) {
      return b._apply_rules(m, a, d, l);
    },
    inflect: function(o, n, m, l) {
      n = parseInt(n, 10);
      if (isNaN(n)) {
        return o;
      }
    ...
    foreign_key: function(m, l) {
      m = b.demodulize(m);
      m = b.underscore(m) + (l ? "" : "_") + "id";
      return m;
    },
    ordinalize: function(s) {
      var q = s.split(" ");
      var o = 0;
      var n = q.length;
      for (; o < n; o++) {
