...
export class Sequelize extends Hooks {
  ...
  public static beforeCreate(
    name: string,
    fn: (attributes: Model, options: CreateOptions) => void
  ): void;
  public static beforeCreate(
    fn: (attributes: Model, options: CreateOptions) => void
  ): void;
  ...
  public static beforeUpdate(
    name: string,
    fn: (instance: Model, options: UpdateOptions) => void
  ): void;
  public static beforeUpdate(
    fn: (instance: Model, options: UpdateOptions) => void
  ): void;
  ...
  public static beforeSave(
    name: string,
    fn: (instance: Model, options: UpdateOptions | CreateOptions) => void
  ): void;
  public static beforeSave(
    fn: (instance: Model, options: UpdateOptions | CreateOptions) => void
  ): void;
  ...
  public static beforeBulkCreate(
    name: string,
    fn: (instances: Model[], options: BulkCreateOptions) => void
  ): void;
  public static beforeBulkCreate(
    fn: (instances: Model[], options: BulkCreateOptions) => void
  ): void;
  ...
  public static beforeBulkDestroy(
    name: string,
    fn: (options: BulkCreateOptions) => void
  ): void;
  public static beforeBulkDestroy(
    fn: (options: BulkCreateOptions) => void
  ): void;
  ...
  public static afterBulkDestroy(
    name: string,
    fn: (options: DestroyOptions) => void
  ): void;
  ...
  public beforeDefine(
    name: string,
    fn: (attributes: ModelAttributes, options: ModelOptions) => void
  ): void;
  public beforeDefine(
    fn: (attributes: ModelAttributes, options: ModelOptions) => void
  ): void;
 ...
 */
export function and(
  ...args: (WhereOperators | WhereAttributeHash | Where)[]
): AndOperator;
