...
export interface ModelHooks<M extends Model = Model> {
  ...
  beforeSave(
    instance: M,
    options: InstanceUpdateOptions | CreateOptions
  ): HookReturn;
  afterSave(
    instance: M,
    options: InstanceUpdateOptions | CreateOptions
...
export class Hooks {
   ...
   */
  public static removeHook<
    C extends typeof Hooks,
    K extends keyof SequelizeHooks
  >(hookType: K, name: string): C;
   ...
   *   hooks based on some sort of priority system in the future.
   */
  public addHook<K extends keyof SequelizeHooks>(
    hookType: K,
    name: string,
    fn: SequelizeHooks[K]
  ): this;
   ...
   * Remove hook from the model
   */
  public removeHook<K extends keyof SequelizeHooks>(
    hookType: K,
    name: string
  ): this;
