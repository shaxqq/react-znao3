...
function removeColumn(qi, tableName, columnName, options) {
  ...
  return qi.sequelize
    .query(
      qi.QueryGenerator.getForeignKeyQuery(
        tableName.tableName
          ? tableName
          : {
              tableName,
    ...
    .then(([results]) => {
      ...
      return Promise.map(results, constraint =>
        qi.sequelize.query(
          qi.QueryGenerator.dropForeignKeyQuery(
            tableName,
  ...
  return qi.sequelize
    ...
    .then(constraints => {
      ...
      if (constraint.constraintType === "FOREIGN KEY") {
        query = qi.QueryGenerator.dropForeignKeyQuery(
          tableName,
          constraintName
        );
      } else {
        query = qi.QueryGenerator.removeIndexQuery(
