...
export function mapFinderOptions<T extends OptionsForMapping>(
  options: T,
  model: typeof Model
): T;

/* Used to map field names in attributes and where conditions */
export function mapOptionFieldNames<T extends OptionsForMapping>(
  options: T,
  model: typeof Model
): T;
...
export function mapValueFieldNames(
  dataValues: object,
  fields: string[],
  model: typeof Model
): object;
...
export function combineTableNames(
  tableName1: string,
  tableName2: string
): string;
 ...
 */
export function classToInvokable<T extends new (...args: any[]) => any>(
  ctor: T
): T & {
