 ...
 */
export interface AggregateOptions<T extends DataType | unknown>
  extends QueryOptions,
    Filterable,
    Paranoid {
  /**
...
export interface IncrementDecrementOptionsWithBy
  extends IncrementDecrementOptions {
  /**
...
export abstract class Model<T = any, T2 = any> extends Hooks {
  ...
  public setAttributes<K extends keyof this>(
    key: K,
    value: this[K],
    options?: SetOptions
  ): this;
