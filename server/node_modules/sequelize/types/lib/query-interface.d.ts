...
export interface QueryOptionsWithType<T extends QueryTypes>
...
export interface QueryInterfaceDropAllTablesOptions
  extends QueryInterfaceOptions {
  skip?: string[];
}
...
export class QueryInterface {
   ...
   * Drops all tables.
   */
  public dropAllSchemas(
    options?: QueryInterfaceDropAllTablesOptions
  ): Promise<void>;
