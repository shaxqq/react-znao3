!(function(c, M) {
  ...
  function X(c, M) {
    for (var z, A; (A = 6e4 * (((M.at - c.at) / 12e4) | 0)); )
      (z = new e(new Date(c.at + A))).offset === c.offset ? (c = z) : (M = z);
    return c;
  }
  function f(c, M) {
    ...
    var z,
      ...
      o = (function() {
        var c,
          ...
          b = new e(new Date(A, 0, 1)),
          o = [b];
        for (z = 1; z < 48; z++)
          (M = new e(new Date(A, z, 1))).offset !== b.offset &&
            ((c = X(b, M)), o.push(c), o.push(new e(new Date(c.at + 6e4)))),
            (b = M);
        for (z = 0; z < 4; z++)
          o.push(new e(new Date(A + z, 0, 1))),
            o.push(new e(new Date(A + z, 6, 1)));
        return o;
      })(),
      p = o.length,
      n = (function(c) {
        ...
        for (M in o) o.hasOwnProperty(M) && p.push(O[M]);
        return p;
      })(o),
      a = [];
    for (A = 0; A < n.length; A++) {
      for (z = new d(u(n[A]), p), b = 0; b < p; b++) z.scoreOffsetAt(o[b]);
      a.push(z);
    }
  ...
  function u(c, M) {
    ...
    return A instanceof W
      ...
      ? ((A = new W(A)), (p[c] = A))
      : n[c] && M !== u && (z = u(n[c], u))
      ? ((A = p[c] = new W())._set(z), (A.name = O[c]), A)
      : null;
  }
  function t(c) {
    var M, z, A, b;
  ...
  function R(c) {
    ...
    return (
      A && !o.isMoment(c) && C(b) && b.add(A.parse(b), "minutes"), b.tz(z), b
    );
  }
  (z < 2 || (2 == z && A < 6)) &&
    E(
    ...
    (R.names = function() {
      var c,
        M = [];
      for (c in O)
        O.hasOwnProperty(c) && (p[c] || p[n[c]]) && O[c] && M.push(O[c]);
      return M.sort();
    }),
    (R.Zone = W),
    (R.unpack = i),
